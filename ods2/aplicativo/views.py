...
from aplicativo.services.ConexaoMongoDB import ConexaoDATABASE, FindCPF, InsertAPOIO, InsertCNPJ, InsertCPF
...
def Login(request):
    if request.method == 'POST':
        ...
        if cliente:
            ...
            return redirect('junte')
        # if cliente:
        #     return HttpResponse('Documento encontrado: Email: {}, Senha: {}'.format(email, senha))
        # else:
