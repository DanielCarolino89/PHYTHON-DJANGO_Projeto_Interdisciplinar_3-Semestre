...
class cpfForm(forms.ModelForm):
    class Meta:
        model = cpfModels
        fields = ['email','senha','cpf','rg','orgao','nome','idade','endereco','numero','bairro','cidade','estado','telefone','celular','sobre','encontrou','declaracao']

class cnpjForm(forms.ModelForm):
    class Meta:
        model = cnpjModels
        fields = fields = ['email','senha','cnpj','empresa','responsavel','cargo','endereco','numero','bairro','cidade','estado','telefone','celular','sobre','encontrou','declaracao']
